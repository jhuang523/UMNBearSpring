...
if __name__ == '__main__':
    ...
    parser.add_argument('--settings_file', type = str, default = '../../data/networks/input/conduits.yaml', help = 'yaml file for network settings')
    parser.add_argument('--output_dir', type = str, default = '../../data/networks/output', help = 'output dir for generated networks')
    ...
    generate_n_networks(n, settings_file, output_dir, fname, verbose=verbose)
