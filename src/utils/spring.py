...
def find_peak(t, Q_spring):
    #find time of peak flow in spring hydrograph
    peak_idx = np.argmax(Q_spring)
    return peak_idx, t[peak_idx], Q_spring[peak_idx]
...
def calculate_volume(t, Q_spring):
    #calculate volume by integrating Q over time using trapezoidal rule
